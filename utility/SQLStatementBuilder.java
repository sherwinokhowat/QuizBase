 ...
 *
 * The SQL Statement string can be generated by calling the object's {@code .toString()} method.
 *
 * @author Ricky Qin
 */
public class SQLStatementBuilder {
    ...
    private static int DELETE_FROM = 6;
     ...
     * @return This SQL statement
     */
    public SQLStatementBuilder values(String... cols) {
        values = cols;
        return this;
    }
     ...
     * @return This SQL statement
     */
    public SQLStatementBuilder set(Pair<String, String>... cols) {
        set = cols;
        return this;
    }
